...
import guichaguri.betterfps.installer.json.JSONArray;
import java.io.*;
import java.net.URL;
import java.util.ArrayList;
import java.util.List;
import guichaguri.betterfps.BetterFpsHelper;
import guichaguri.betterfps.installer.json.JSONObject;
...
public class InstanceInstaller {
    ...
    private static final String TWEAKER = "guichaguri.betterfps.tweaker.BetterFpsTweaker";
