...
import guichaguri.betterfps.transformers.cloner.CopyBoolCondition;
...
public class BeaconRenderer extends TileEntityBeaconRenderer {
    ...
    @CopyMode(CopyMode.Mode.IGNORE) // Ignore the constructor to prevent an infinite loop
    public BeaconRenderer() {}

    @CopyBoolCondition(key = "fastBeaconRender", value = true)
