            ...
            if(Naming.M_onUpdate.is(method.name, method.desc)) {
                ...
                for(AbstractInsnNode node : method.instructions.toArray()) {
                    if(!b && node instanceof LabelNode) {
                        ...
                        list.add(new FieldInsnNode(Opcodes.GETSTATIC, "guichaguri/betterfps/BetterFps", fieldName, "I"));

                        list.add(new InsnNode(Opcodes.DUP));
                        list.add(new InsnNode(Opcodes.ICONST_1));
                        list.add(new InsnNode(Opcodes.IADD));
                        list.add(new FieldInsnNode(Opcodes.PUTSTATIC, "guichaguri/betterfps/BetterFps", fieldName, "I"));

                        list.add(new FieldInsnNode(Opcodes.GETSTATIC, "guichaguri/betterfps/BetterFps", maxFieldName, "I"));
